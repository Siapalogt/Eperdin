...
export default function PesertaManifestTable({ perjalananId, pesertaList = [], onOpenBiayaModal, formatRp }: Props) {
                                ...
                                return (
                                    <tr key={row.id} className="hover:bg-slate-50/50 transition">
                                        ...
                                        <td className="px-6 py-4 text-center space-x-2">
                                            <button onClick={() => onOpenBiayaModal(row)} className="px-3 py-1.5 bg-emerald-50 text-emerald-700 hover:bg-emerald-600 hover:text-white rounded-lg text-xs font-bold transition border border-emerald-200">
